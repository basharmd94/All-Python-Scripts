"""
📦 HM_23_Zepto_Acct_Aging_Weekly.py – Weekly Zepto Accounts Receivable Aging Report

🚀 PURPOSE:
    - Generate weekly aging report for Zepto (ZID=100005)
...
📁 OUTPUT:
    - HM_23_ZeptoReceivableAging.xlsx → Two sheets:
...
📬 EMAIL:
    - Recipients: get_email_recipients("HM_23_Zepto_Acct_Aging_Weekly") → auto-detect from filename
    - Subject: "HM_23 – Zepto Accounts Receivable Aging Report"
    - Body: Professional message with "Dear Sir"
    - HTML: Embedded aging and info tables
    - Attachment: HM_23_ZeptoReceivableAging.xlsx
...
📌 ENHANCEMENTS:
    ...
    - No HTML file created — uses html_body
    - Professional email body with "Dear Sir"
...
with pd.ExcelWriter('HM_23_ZeptoReceivableAging.xlsx', engine='openpyxl') as writer:
...
body_text = (
    "Dear Sir,\n\n"
    "Please find the weekly Zepto Accounts Receivable Aging Report attached.\n\n"
    "This report includes:\n"
    "- Aging of outstanding customer balances (5D to RED >90D)\n"
    "- Average days between key transaction types (INOP, RCT, SRT, SRJV)\n\n"
    "This report helps track collection efficiency and customer payment behavior.\n\n"
    "Best regards,\n"
    "Automated Reporting System"
)

# ✅ Pass DataFrames directly to html_body
html_content = [
    (df_aging, "Zepto AR Aging Summary"),
...
# Runtime
print(f"✅ HM_23 completed successfully in {time.time() - start_time:.2f} seconds.")